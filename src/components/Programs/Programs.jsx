        ...
        <section className="programs">
            <div className="section-container">
                <div className="programs-header">
                    <div className="sort-icon-container"><MySvgComponent /></div>
                    <div className="programs-header-buttons">
                        <button className="button">الناشئون</button>
                        <button className="button active">الكبار</button>
                    </div>
                    <h2 className="main-title">المعسكرات والبرامج</h2>
                </div>
            </div>
        </section>
    )
...
const MySvgComponent = () => {
    return (
        <svg
            ...
            enableBackground="new 0 0 122.88 117.824"
            xmlSpace="preserve"
        >
            <g>
                <path
